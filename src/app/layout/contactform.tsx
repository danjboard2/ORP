            ...
            <section className="w-full flex flex-row">
                <div className="w-full flex flex-col lg:flex-row max-w-[2000px] m-auto justify-center items-center my-12 gap-6">
                    ...
                    <div className="w-2/3 text-center lg:text-left lg:w-1/5">
                        ...
                        <Link href="/contact" className="inline-block w-fit text-base sm:text-lg xl:text-2xl rounded-full border-4 border-[#3AAA01] px-10 xl:px-12 py-2 font-bold text-[#3AAA01] mt-10 lg:mt-24 hover:bg-[#3AAA01] hover:text-white">Enquire now</Link>
                    </div>
                </div>
            </section>
            </>
