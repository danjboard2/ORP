...
export default function Footer() {
    return (
       <footer className="flex flex-row sm:flex-col space-around bg-black w-full text-white px-10 py-8">
         ...
         <div className="flex min-w-[130px] w-full sm:w-1/2 sm:w-1/4 items-center justify-center sm:border-r-[1px] border-[#404041]">
         ...
         <div className="flex flex-col sm:flex-row w-full sm:w-3/4">
            ...
            <div className="flex w-full sm:w-1/3 justify-center">
               <div className="flex flex-col w-full pl-6 sm:pl-10 text-center sm:text-left">
            ...
            <div className="flex w-full sm:w-1/3 justify-center">
               ...
               <Link href="https://twitter.com" className="m-auto mb-4 sm:ml-0"><SiTwitter size={25}/></Link>
               <Link href="https://discord.com" className="m-auto mb-4 sm:ml-0"><SiDiscord size={25}/></Link>
               </div>
            </div>
            { /* end col of footer */}
