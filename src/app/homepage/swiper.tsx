  ...
  return (
    ...
    <div className="navigate w-full max-w-[2000px] flex flex-col lg:flex-row justify-between m-auto px-4 xl:px-10 2xl:px-32 !mb-12">
        ...
        <div className="h-[120px] mb-14">
          ...
          <p className="text-md xl:text-xl">Mold due to moisture events is extremely hazardous to people and employees. Mold Treatment 1&2 are ORP’s flagship product category that target and eliminate surface mold on contact. Developed as an alternative to harmful chemical options, it can be applied throughout structures and buildings simply and safely without added health risk.</p>
          <Link href="/mold" className="item-button block w-4/5 m-auto border-solid border-2 color-[#404041] rounded-full text-lg xl:text-2xl px-10 py-2 border-[#404041] mt-6">Learn more</Link>
          </div>
