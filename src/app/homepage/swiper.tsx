...
export default function HomepageSwiper() {
  ...
  return (
    ...
    id="homeswiper"
      ...
      pagination={false}
    >
      <SwiperSlide className="!flex flex-col justify-center px-32"><Image src="/media/images/soil.jpg" id="swiperimage" className="absolute object-cover block -z-[1] top-0 left-0 right-0 bottom-0 min-w-[100%] min-h-[965px] w-auto h-auto" width={3000} height={3000} alt="Soil"></Image><div className="flex flex-col w-full max-w-[2000px] m-auto 3xl:px-32 pt-[100px]"><h1 className="text-7xl font-bold uppercase text-white [text-shadow:_0_5px_6px_rgb(0_0_0_/_80%)]">Hydrocarbon</h1><h2 className="text-4xl my-6 font-bold text-white [text-shadow:_0_5px_6px_rgb(0_0_0_/_80%)]">ORP-SR1 & ORP-SR2</h2><Link href="/soil" className="inline-block w-fit text-2xl rounded-full border-4 border-[#3AAA01] px-20 py-2 font-bold text-[#3AAA01] mt-24 hover:bg-[#3AAA01] hover:text-white">Learn more</Link></div></SwiperSlide>
      <SwiperSlide className="!flex flex-col justify-center px-32"><Image src="/media/images/mold.jpg" id="swiperimage" className="absolute object-cover block -z-[1] top-0 left-0 right-0 bottom-0 min-w-[100%] min-h-[965px] w-auto h-auto" width={3000} height={3000} alt="Soil"></Image><div className="flex flex-col w-full max-w-[2000px] m-auto 3xl:px-32 pt-[100px]"><h1 className="text-7xl font-bold uppercase text-white [text-shadow:_0_5px_6px_rgb(0_0_0_/_80%)]">Mold</h1><h2 className="text-4xl my-6 font-bold text-white [text-shadow:_0_5px_6px_rgb(0_0_0_/_80%)]">ORP-MT1 & ORP-MT2</h2><Link href="/mold" className="inline-block w-fit text-2xl rounded-full border-4 border-[#3AAA01] px-20 py-2 font-bold text-[#3AAA01] mt-24 hover:bg-[#3AAA01] hover:text-white">Learn more</Link></div></SwiperSlide>
      <SwiperSlide className="!flex flex-col justify-center px-32"><Image src="/media/images/sewage.jpg" id="swiperimage" className="absolute object-cover block -z-[1] top-0 left-0 right-0 bottom-0 min-w-[100%] min-h-[965px] w-auto h-auto" width={3000} height={3000} alt="Soil"></Image><div className="flex flex-col w-full max-w-[2000px] m-auto 3xl:px-32 pt-[100px]"><h1 className="text-7xl font-bold uppercase text-white [text-shadow:_0_5px_6px_rgb(0_0_0_/_80%)]">Sewage</h1><h2 className="text-4xl my-6 font-bold text-white [text-shadow:_0_5px_6px_rgb(0_0_0_/_80%)]">ORP-WS1 & ORP-WS2</h2><Link href="/sewage" className="inline-block w-fit text-2xl rounded-full border-4 border-[#3AAA01] px-20 py-2 font-bold text-[#3AAA01] mt-24 hover:bg-[#3AAA01] hover:text-white">Learn more</Link></div></SwiperSlide>
    </Swiper>
