...
export default function HomepageSwiper() {
  ...
  return (
    ...
    >
      ...
      <SwiperSlide className="!flex flex-col justify-center px-4 lg:px-32"><Image src="/media/images/sewage.jpg" id="swiperimage" className="absolute object-cover block -z-[1] top-0 left-0 right-0 bottom-0 min-w-[100%] min-h-[965px] w-auto h-auto" width={3000} height={3000} alt="Soil"></Image><div className="flex flex-col w-full max-w-[2000px] text-center lg:text-left m-auto 3xl:px-32 pt-[100px]"><h1 className="text-4xl xl:text-7xl font-bold uppercase text-white [text-shadow:_0_5px_6px_rgb(0_0_0_/_80%)]">Sewage</h1><h2 className="text-2xl xl:text-4xl my-6 font-bold text-white [text-shadow:_0_5px_6px_rgb(0_0_0_/_80%)]">ORP-WS1 & ORP-WS2</h2><Link href="/sewage" className="inline-block  m-auto lg:ml-0 w-fit text-lg xl:text-2xl rounded-full border-4 border-[#3AAA01] px-10 xl:px-20 py-2 font-bold text-white lg:text-[#3AAA01] mt-24 bg-[#3AAA01] lg:bg-transparent hover:bg-[#3AAA01] hover:text-white">Learn more</Link></div></SwiperSlide>
    </Swiper>
    <div className="navigate w-full max-w-[2000px] flex flex-col lg:flex-row justify-between m-auto px-4 xl:px-10 2xl:px-32 !mb-12">
        ...
        <div className="h-[120px] -mb-[50px]">
          ...
          <p className="text-md xl:text-xl  flex-auto">Mold due to moisture events is extremely hazardous to people and employees. Mold Treatment 1&2 are ORP’s flagship product category that target and eliminate surface mold on contact. Developed as an alternative to harmful chemical options, it can be applied throughout structures and buildings simply and safely without added health risk.</p>
          <Link href="/mold" className="item-button block w-4/5 m-auto border-solid border-2 color-[#404041] rounded-full text-lg xl:text-2xl px-10 py-2 border-[#404041] mt-6 font-bold">Learn more...</Link>
          </div>
